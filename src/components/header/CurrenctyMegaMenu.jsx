...
const CurrenctyMegaMenu = ({ textClass }) => {
  ...
  const currencyContent = [
    ...
    { id: 10, name: "Indian Rupee", currency: "INR", symbol: "₹" },
    ...
    { id: 21, name: "The Euro", currency: "EUR", symbol: "€" },
    { id: 22, name: "Great British Pound", currency: "GBP", symbol: "£" },
    { id: 23, name: "UAE Dirham", currency: "AED", symbol: "د.إ" },
  ];
